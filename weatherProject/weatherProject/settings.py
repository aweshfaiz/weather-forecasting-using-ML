...
# Load environment variables from repo root .env (one level above BASE_DIR)
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-^-549&ui)jf4xvzk9(v0^@bu-7wu3#ib9=2eq*2gb*w!=$jw-y')
